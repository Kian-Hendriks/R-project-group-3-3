...
#Prijzen_bestaande_koopwoningen <- 
#read.csv2("~/Downloads/Prijzen bestaande koopwoningen.csv", header=FALSE)

write.csv(Prijzen_bestaande_koopwoningen, "data/woningprijs.csv")
