...
write.csv(datacombi1523, "Goede data/datacombined15tot23goed.csv")
...
## 3.1 Data cleaning
```{r}
names(datacombined15tot23)[names(datacombined15tot23) == "X1.000.euro...6"] <- "gem_st_inkomen_x_100"

names(datacombined15tot23)[names(datacombined15tot23) == "X1.000.euro...7"] <- "med_st_inkomen_x_100"

names(datacombined15tot23)[names(datacombined15tot23) == "X1.000.euro...8"] <- "gem_bstb_inkomen_x_100"

names(datacombined15tot23)[names(datacombined15tot23) == "X1.000.euro...9"] <- "med_bstb_inkomen_x_100"
