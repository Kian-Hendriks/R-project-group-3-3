...
```{r}
names(datacombined15tot23goed)[names(datacombined15tot23goed) == "X1.000.euro...6"] <- "gem_st_inkomen_x_1000"

names(datacombined15tot23goed)[names(datacombined15tot23goed) == "X1.000.euro...7"] <- "med_st_inkomen_x_1000"
...
=======
names(datacombined15tot23goed)[names(datacombined15tot23goed) == "X1.000.euro...8"] <- "gem_bstb_inkomen_x_1000"
...
write.csv(gem_huizenprijs_per_provincie, "goede data/gem_huizen_per_provincie_goed.csv")
