...
Variable 1
maken van nieuwe variabele 1, we hebben hier het gemiddelde besteedbare inkomen van iedere provincie over 8 jaar. aldus het gemiddeld
...
Variable 2
maken van nieuwe variabele 2 gebruik gemaakt van de oorspronkelijke dataset:datacombined15tot23goed. waarin we de gewogen gemiddeldes van het inkomen van verschillende provincies: binnen en buiten de randstad hebben gerepresenteerd 

de vorm van de huidige gecleande dataset aanpassen om dan zo verder te kunnen werken met een vernieuwde dataset en ook een vernieuwde dataset. omdat we voor deze nieuwe variabele eigenlijk onze twee datasets moeten samenvoegen.
```{r gen_var2}
...
ggplot(nl_map) +
  ...
  scale_fill_viridis_c(name = "Mean income (x100 €)") +
  theme_minimal() +
  labs(
