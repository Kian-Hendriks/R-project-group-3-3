...
to long format (one row per province per year) and merging it with the income data, so that
income and house prices could be compared on the same regional and yearly basis. This
variable lets us contrast the economically dense Randstad with the peripheral provinces.
```{r gen_var2}
...
<!-- DRAFT: verify & adjust -->
The third variable combines population density with the average house price for each
...
3.5). A fourth variable, the price-to-income ratio, is generated later in the event
...
central to this report, and it is visibly larger in the Randstad than outside it.
...
up -- precisely in the crowded provinces where most people want or need to live, housing is
least affordable.
