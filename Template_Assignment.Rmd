...
nl_map_base <- st_read("https://cartomap.github.io/nl/wgs84/provincie_2024.geojson")

plot_nl <- function(data, value_col, fill_palette, legend_title, plot_title, subtitle = NULL) {
  nl_map <- merge(nl_map_base, data, by.x = "statnaam", by.y = "Provincies")
...
plot_nl(inkomen, "mean_income", "Blues",
        "Mean spendable income (x100 €)",
        "Mean Spendable Income per Province",
        "Average over 2015-2023")

plot_nl(huizen, "huizenprijs", "Greens",
        "Gem. huizenprijs (€)",
        "Gemiddelde Huizenprijs per Provincie",
